...
(1891234567890123458, 1891234567890123456, '分布式锁', 'DistributedLock', '/demo/distributed-lock', '/examples/distributed-lock/index', 'ri:lock-line', 2, 1, 1),
(1891234567890123459, 1891234567890123456, '延迟队列', 'DelayQueue', '/demo/delay-queue', '/examples/delay-queue/index', 'ri:timer-line', 3, 1, 1);
