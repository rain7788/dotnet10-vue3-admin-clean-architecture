  ...
  <div class="w-full py-2">
    ...
    <div class="mb-6">
      ...
      <p class="m-0 text-sm leading-[1.6] text-g-700">
        此页面仅对<strong class="font-semibold text-warning">超级管理员</strong>用户可见，演示页面级别的权限控制。 如果您能看到此页面，说明您拥有相应的访问权限。
      </p>
    </div>
          ...
          <ElTimeline>
            ...
            <ElTimelineItem timestamp="后端控制模式" type="warning" size="large">
              <ElCard shadow="never">
                ...
                <p class="m-0 mb-2 leading-[1.6] text-g-700">在后端控制模式下，页面访问权限由后端统一管理，前端通过解析后端接口返回的菜单列表来生成可访问的路由，从而实现权限控制
                </p>
