...
using Art.Domain.Entities;
using Art.Infra.MultiTenancy;

namespace Art.Infra.Data;

/// <summary>
/// 应用数据库上下文
/// 继承 MultiTenantDbContext 自动支持多租户过滤
/// </summary>
public class ArtDbContext : MultiTenantDbContext
{
    public ArtDbContext(
        DbContextOptions<ArtDbContext> options,
