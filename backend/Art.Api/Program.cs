...
{
    options.SwaggerDoc(ApiGroups.Admin, new() { Title = "Art 管理端 API", Version = "v1" });
    options.SwaggerDoc(ApiGroups.App, new() { Title = "Art 应用端 API", Version = "v1" });
    options.SwaggerDoc(ApiGroups.Common, new() { Title = "Art 公共端 API", Version = "v1" });
