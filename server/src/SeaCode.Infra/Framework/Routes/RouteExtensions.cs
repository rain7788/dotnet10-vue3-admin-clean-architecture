...
public static class RouteExtensions
{
    ...
    public static void ConfigureApiGroups(this WebApplication app)
    {
        ...
        // 游戏 API - 需要玩家端 Token
        var gameGroup = api.MapGroup(ApiGroups.Game)
        ...
        // 注册游戏路由
        var gameRouters = app.Services.GetServices<IGameRouterBase>();
        foreach (var router in gameRouters)
        {
            router.AddRoutes(gameGroup);
        }
